...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      {/* Decorative shapes */}
      <div className="absolute top-32 right-20 w-16 h-16 bg-yellow-400 rounded-2xl rotate-12 opacity-60 animate-bounce-gentle hidden lg:block" />
      <div className="absolute bottom-40 left-20 w-12 h-12 bg-emerald-400 rounded-full opacity-60 animate-float hidden lg:block" />
      <div className="absolute top-1/2 right-32 w-8 h-8 bg-violet-400 rounded-lg rotate-45 opacity-60 animate-float-delayed hidden lg:block" />

      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-200/50 text-red-500 font-medium text-sm mb-8 animate-fade-in">
          ...
          >
            KASMARA adalah karpet pintar interaktif yang menggabungkan gerakan
            fisik dengan respons audio edukatif untuk merangsang kemampuan
            bahasa, sensorik, dan fokus anak.
          </p>
